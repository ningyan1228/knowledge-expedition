...
with seed(id,knowledge_id,level_id,stem,a,b,c,d,answer,summary,why_correct,why_wrong,mistake,tip,difficulty) as (values
  ...
  ('nature-tech-07','nature-wuqinxi','nature-tech-1','下列哪项不属于华佗的相关贡献？','五禽戏','麻沸散','《伤寒杂病论》','夹脊穴','C','正确答案：《伤寒杂病论》','《伤寒杂病论》作者是张仲景；五禽戏、麻沸散等常与华佗相关。','题目故意把两位东汉医学家的成果放在一起。','把华佗与张仲景的医学成果混为一谈。','张仲景伤寒论，华佗五禽麻沸。',3),
  ...
  ('nature-boss-01','nature-four-inventions','nature-boss','下列“技术—作用”对应正确的是？','指南针—辅助航海导航','活字印刷—测量地震','造纸术—制造火药','火药—记录经纬度','A','正确答案：指南针—辅助航海导航','指南针的核心作用是辨别方向、辅助导航。','其余选项将不同技术的用途交叉错配。','只背技术名称，不理解实际用途。','指南导航，纸写印传，火药军用。',3),
  ('nature-boss-02','nature-cell','nature-boss','下列生命活动的叙述，正确的是？','呼吸作用只在白天进行','光合作用可制造有机物','细胞不是生命活动的基本单位','氧气是光合作用吸收的主要气体','B','正确答案：光合作用可制造有机物','光合作用利用光能合成有机物并释放氧气。','呼吸作用并非只在白天进行；细胞是结构和功能基本单位。','将光合、呼吸和细胞层级混为同一概念。','光合造有机物，细胞是基本单位。',3),
  ('nature-boss-03','nature-wave-light','nature-boss','下列关于声和光的说法，正确的是？','声音和光都不能在真空传播','声音可在真空传播，光不能','光可在真空传播，声音不能','声音和光都必须依靠空气传播','C','正确答案：光可在真空传播，声音不能','光是电磁波，可以在真空传播；声音是机械波，需要介质。','“空气”只是常见介质，不是光传播的必要条件。','把声音、光都当作同一种波来理解。','真空不传声，光能穿真空。',3),
  ('nature-boss-04','nature-earth-space','nature-boss','下列现象与地球运动对应正确的是？','昼夜交替—地球自转','四季变化—月球公转','太阳东升西落—地球公转','木星最大—地球自转','A','正确答案：昼夜交替—地球自转','地球自转带来昼夜交替及太阳的周日视运动；四季与公转和地轴倾斜有关。','其余选项把不同天文现象的成因拼接在一起。','把日常观测现象与真实运动机制混淆。','自转昼夜，公转倾斜四季。',3)
)
